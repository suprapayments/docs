...
The payments page shows all recent payments in reverse chronological order (from most recent to least recent).

Clicking on any row will allow you to view more detailed information about each particular payment.

# Individual Payments

Clicking on any of the payments takes us into a page where we can see more details about each order.
