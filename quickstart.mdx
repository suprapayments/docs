...
Adding a testnet address could be useful, if you intend to use this [Test environment](https://docs.suprapayments.io/environments/environments), which allows you to test the account and checkout pages without risking any real (mainnet) tokens.
